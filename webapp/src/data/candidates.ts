...
export interface Municipality { id: string; name: Lz; province: string; alprStatus: 'installed' | 'considering' | 'mobile_only' | 'none' | 'deployed'; statusNote: Lz; coords: [number, number]; election: { date: string; body: Lz } | null; statusEvidence: Evidence[] }
